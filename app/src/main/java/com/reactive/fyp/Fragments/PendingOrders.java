...
import com.reactive.fyp.databinding.FragmentPendingOrdersBinding;
...
public class PendingOrders extends Fragment implements OrderAdapterListener {


    final String TAG = PendingOrders.class.getSimpleName();
